...
INDICATORS <- c(
  ...
  "mfhi_f_p12mos_wwo_dkr" = "Financial health outcomes/ Managing day-to-day: Food security: Went without food in past 12 months due to lack of money: Refused to answer", 
  ...
  "mfhi_d_p3mo_stress_dkr" = "Financial health outcomes/ Managing day-to-day: Debt: Reduced food expenses to repay debt in past 3 months: Don't know/refused to answer", 
  ...
  "mfhi_ef_30d_srcany_dkr" = "Financial health outcomes/ Coping with risk: Access to emergency funds: Can raise 1/20 of GNI per capita in 30 days: Don't know/refused to answer", 
  ...
  "mfhi_i_fc_p12mos_any" = "Financial health outcomes/ Capital investments: Financial assets: Contribute to- or purchased- any financial asset that support long-term security: Yes", 
  ...
  "mfhi_i_p12mos_any" = "Financial health outcomes/ Capital investments: Has personally purchased- or contributed to- assets that support production, productivity or long-term financial security", 
  
  "mfhi_score_hi" = "Financial health outcomes/ Summary: MFHI: Score category: High (0.6-1)", 
  "mfhi_score_med" = "Financial health outcomes/ Summary: MFHI: Score category: Medium (0.3-0.6)", 
  "mfhi_score_low" = "Financial health outcomes/ Summary: MFHI: Score category: Low (0-0.3)", 
...
GROUPS <- c("resp_all" = "All adults (18+)", 
            "resp_gender" = "Gender", 
            "resp_age_agg4_str" = "Age (categories)", 
